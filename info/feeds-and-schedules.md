...
See root [`README.md`](../README.md) for overall usage, production vs dev modes, and launchd setup. Implementation: `generate_rumble_feed.py`, `publish_rumble_feed.sh`, `rumble_feed_tick.sh`.
