...
- Fallback thumbs (no Rumble match): probe `https://www.worldministries.org/Userfiles/video-thumbs/{YYYYMMDD}.jpg` for the schedule Friday air date; show non-clickable card if the image loads.
